    ...
    <div className="min-h-screen flex items-center justify-center py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-bg-dark to-bg-dark">
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <h2 className="mt-6 text-center text-3xl font-bold text-white">Access Your Data</h2>
          <p className="mt-2 text-center text-sm text-slate-400">
            Enter your unique username/key to continue.
          </p>
        </div>
        <form className="mt-8 space-y-6 glass p-10 rounded-3xl backdrop-blur-xl shadow-2xl border border-white/10" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                {loading ? '...' : 'Register Key'}
              </button>
            </div>

          <div className="text-center text-xs text-stone-500 mt-4 px-4 leading-relaxed">
            Don't have a key? Enter a name and register it in the <span className="text-primary font-bold">Settings</span> tab after entering the dashboard (if you have guest access).
          </div>
        </form>
      </div>
    </div>
